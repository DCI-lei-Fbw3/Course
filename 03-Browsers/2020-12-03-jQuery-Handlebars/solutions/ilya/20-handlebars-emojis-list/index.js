...
/* copy pasted Anna's solution

let emojiList = Handlebars.compile(
    "{{#each emoji}}" +
      "<tr><td><img src={{this}}></td><td>{{@key}}</td></tr>" +
      "{{/each}}"
  );
  let outputSection = document.getElementById("output");
  outputSection.innerHTML = emojiList({ emoji: emojis });

*/

/* Anna's solution in JS */
