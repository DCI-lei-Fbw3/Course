...
// implement the modulo function using the values of the modulo input fields(first modulo and second modulo), and store the result as value in the modulo_result input field: 
...
let firstModulo = document.getElementById('modulo_1');
// add an event listener "input" which stores the input value, and a callback func which calculates the result: 
firstModulo.addEventListener("input", calcModulo);

//select the second modulo input field by its id: 
let secondModulo = document.getElementById('modulo_2');
// add an event listener "input" which stores the input value, and a callback func which calculates the result: 
secondModulo.addEventListener("input", calcModulo);
...
secondPercentage.addEventListener("input", calcPercentage)
...
secondPercentageOf.addEventListener("input", calcPercentageOf)
...
// Calculate Aspect Ration Section: 
