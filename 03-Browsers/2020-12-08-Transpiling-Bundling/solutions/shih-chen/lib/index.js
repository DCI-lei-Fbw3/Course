...
import { calculateAspectRatio } from './aspect-ratio.js'; //modulo
...
for (let i = 0; i < input1.length; i++) {
  input1[i].addEventListener("change", e1 => {
    ...
    mResult.value = percentThing.modulo(val1, val2); //console.log(mResult.value); // the result is a string to fix it convert the values into numbers
  });
} //percentage
