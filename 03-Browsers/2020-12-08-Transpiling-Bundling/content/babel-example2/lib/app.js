...
//if you don't export as default, this method will give a syntax error
console.log(_math["default"].sumAll(20, 3)); //should be 15

console.log(_math["default"].subtractAll(20, 3)); //should be 15

console.log(_math["default"].multiplyAll(20, 3)); //should be 15

console.log(_max["default"].max(20, 3));
