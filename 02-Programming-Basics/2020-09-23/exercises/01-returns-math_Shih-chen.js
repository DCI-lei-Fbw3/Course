...
const dividedByFive = (aNumber) => {
    aNumber%5==0? console.log (`Hurray! The number ${aNumber} can be divided by 5.`):
...
const divisibleBy100 = aNumber => {
    aNumber%100==0? console.log (`True! ${aNumber} can be divided by 100`): console.log (`False! ${aNumber} cannot be divided by 100`);
}
...
const isEven = aNumber => {
    aNumber%2==0? console.log(`${aNumber} is an even number`): isOdd(aNumber);
}
const isOdd = aNumber => {
    aNumber%2!=0? console.log(`${aNumber} is an odd number`): isEven(aNumber);
}
...
const equalSlices = (totalSlice, noPeople, sliceEach) => {
    if (noPeople==0) {
        ...
        if (totalSlice>=noPeople*sliceEach) {
            ...
            leftOver>0? console.log (`We have ${totalSlice} pies for ${noPeople} people with ${sliceEach} pies for each person. We still have ${leftOver} slices of pie left.`): console.log(`We have ${totalSlice} pies for ${noPeople} people with ${sliceEach} pies for each person. We have no slices of pie left.`);
        }
        else {
            let notEnough = noPeople*sliceEach - totalSlice;
            console.log(`We need ${notEnough} pieces of pie more for ${noPeople} people, each of whom takes ${sliceEach} pieces of pie.`);
        }
    }
