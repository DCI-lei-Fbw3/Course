...
function calculateSupply (age, amount) {
    ...
    console.log(`Now you are only ${age} consuming ${amount} box of creamcheese a day.`)
    console.log(`You will need ${total} boxes of creamcheese to last you until the ripe old age of ${maxAge}.`);
}
