// Ola FbW3! Let's talk about Higher-Order Functions, Callback functions, and First-Class Functions
    ...
    // First-Class Functions
        ...
        */
        ...
        Because the purpose of funtional programming, and coding in general,
...
- JavaScript Callback Functions can be synchronously & asychronously 
*/
...
function functionThree (var1, callback1, var2, callback2) {
    
    callback1(var1);
    callback2(var2);
}
functionThree("This is callback 1", function (x) { alert (x);},"This is callback 2!", function (x) { alert (x);});
...
functionFour(2, 2, print); // --> this is where it starts
