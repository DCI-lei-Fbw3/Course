# Deploying your first React App -- Github Pages

## Notes:
- Github Pages is a free Open Source tool for deploying static applications.
- You can find the documentation on how to deploy to GH-Pages using Create-React-App on: https://create-react-app.dev/docs/deployment/.
- Please take the chance today to deploy some React application to get familiar with the process. 
