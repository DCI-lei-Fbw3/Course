...
// this is the callback function for app.post("/login", callbackFunction)
// we require this file in server.js and use it in the routes section like so: app.post("/login", login)
const login = (req, res) => {
